...
export default async function WordsPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return <AppShell><div className="page-wrap"><WordsClient initialWords={words || []} initialQuery={params.q || ''} translationLanguage={profile?.default_translation_language || 'ru'} /></div></AppShell>
}

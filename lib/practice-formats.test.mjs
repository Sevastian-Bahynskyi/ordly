...
test('binary never claims a meaning the word actually has as false', () => {
  ...
  assert.equal(binaryTask({ candidate: c, senses: [c.sense], distractors: [], meaningDistractors: [], newTarget: false }).answer, 'true', 'with no safe wrong meaning, only a true claim is made')

...
const rows = [
  { sense_id: SENSE, level: 'A2', catalog_sentence_variant: [
    { id: 'v2', version: 'x2', danish: 'Tasken ligger på gulvet.', target: 'gulvet', translations: { en: 'The bag is lying on the floor.', ru: 'Сумка лежит на полу.' }, orders: ['På gulvet ligger tasken.'] },

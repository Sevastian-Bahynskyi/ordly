    ...
    const result = await openRouterJson({
      ...
      messages: [
        ...
        { role: 'system', content: task.kind === 'recall'
          ...
          : 'The learner answers in Danish. Accept minor typing slips when the intended word is unambiguous. Never treat a different valid word, changed negation, or the wrong requested transformation as a typo. Any spelling correction must refer to the actual letters in the learner answer. Set corrected to the learner answer with the SMALLEST edits that make it correct, natural Danish for this task, keeping every word that is already right and keeping their wording and intention; if nothing needs changing, return the answer unchanged.' },

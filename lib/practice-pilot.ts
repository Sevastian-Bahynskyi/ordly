 ...
 * situation in their learner language, then chooses a reply. `accepted` lists every reply the
 * content counts as natural, so a second valid answer is never marked wrong; `distractors` are
 * grammatical Danish that does not answer the line. An exchange is offered only when its
...
export const PILOT_DIALOGUES: readonly PilotDialogue[] = [
  {
    ...
    situation: { en: 'A colleague offers you a cup of coffee. Say yes politely.', ru: 'Коллега предлагает вам чашку кофе. Вежливо согласитесь.' },
  ...
  },
  {
    ...
    situation: { en: 'A friend asks about the party on Saturday. You are not sure yet.', ru: 'Друг спрашивает про вечеринку в субботу. Вы ещё не уверены.' },
  ...
  },
  {
    ...
    situation: { en: 'A friend asks what you thought of the film you just watched.', ru: 'Друг спрашивает, что вы думаете о фильме, который вы только что посмотрели.' },
  ...
  },
  {
    ...
    situation: { en: 'Someone at the station asks you for help with a suitcase. Offer to help.', ru: 'На вокзале вас просят помочь с чемоданом. Предложите помощь.' },
  ...
  },
  {
    ...
    situation: { en: 'A friend asks whether you remember a woman’s name. You do not.', ru: 'Друг спрашивает, помните ли вы, как её зовут. Вы не помните.' },
  ...
  },
  {
    ...
    situation: { en: 'An old friend asks whether you still live in Copenhagen. You do.', ru: 'Старый друг спрашивает, живёте ли вы всё ещё в Копенгагене. Да, живёте.' },
  ...
  },
  {
    ...
    situation: { en: 'A friend suggests eating now, but you have already eaten.', ru: 'Друг предлагает поесть сейчас, но вы уже поели.' },
  ...
  },
  {
    ...
    situation: { en: 'A neighbour asks whether you have tried the new bakery. You have not, but you want to.', ru: 'Сосед спрашивает, пробовали ли вы новую пекарню. Вы не пробовали, но хотите.' },
  ...
  },
  {
    ...
    situation: { en: 'At the door, a friend asks if you have your keys. You left them at home.', ru: 'У двери друг спрашивает, взяли ли вы ключи. Вы оставили их дома.' },
  ...
  },
  {
    ...
    situation: { en: 'A friend asks why you do not want to go swimming. The water scares you a little.', ru: 'Друг спрашивает, почему вы не хотите плавать. Вода вас немного пугает.' },

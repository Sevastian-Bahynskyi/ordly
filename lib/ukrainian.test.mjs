...
test('abbreviations and hand-checked dictionary gaps are not called Russian', () => {
  ...
  assert.deepEqual(problems("Він допоміг мені налаштувати комп'ютер."), [], 'an apostrophe word at a sentence end stays whole')
  assert.deepEqual(problems('Ми маємо почати о девʼятій.'), [])
})

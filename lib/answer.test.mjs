...
test('meaning recall accepts understood wording without imposing a Danish production target', () => {
  const feedback = { result: 'mostly', communication: 'yes', target: 'no', relation: 'valid_alternative', feedback: 'Use å instead of a.' }
  assert.deepEqual(normalizeMeaningFeedback(feedback, 'recall'), {
    result: 'correct', communication: 'yes', target: 'yes', relation: 'valid_alternative', feedback: 'This is a valid alternative way to express the saved meaning.',
  })
